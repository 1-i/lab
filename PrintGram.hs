...
instance Print Exp where
  prt i e = case e of
    ...
    EDeref exp -> prPrec i 10 (concatD [doc (showString "*"), prt 10 exp])
    ERefer exp -> prPrec i 10 (concatD [doc (showString "&"), prt 10 exp])
    ERInt -> prPrec i 11 (concatD [doc (showString "readInt"), doc (showString "("), doc (showString ")")])
    ERDou -> prPrec i 11 (concatD [doc (showString "readDouble"), doc (showString "("), doc (showString ")")])
    ERStr -> prPrec i 11 (concatD [doc (showString "readString"), doc (showString "("), doc (showString ")")])
