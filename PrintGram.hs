...
instance Print Ass where
  prt i e = case e of
    DAss exp1 exp2 -> prPrec i 0 (concatD [prt 8 exp1, doc (showString ":="), prt 0 exp2, doc (showString ";")])
...
instance Print Exp where
  prt i e = case e of
    ...
    EDeref exp -> prPrec i 8 (concatD [doc (showString "*"), prt 7 exp])
    ENot exp -> prPrec i 8 (concatD [doc (showString "!"), prt 7 exp])
    EArr exp1 exp2 -> prPrec i 9 (concatD [prt 9 exp1, doc (showString "["), prt 0 exp2, doc (showString "]")])
    ECall id exps -> prPrec i 10 (concatD [prt 0 id, doc (showString "("), prt 0 exps, doc (showString ")")])
    ...
    EParen exp -> prPrec i 10 (concatD [doc (showString "("), prt 0 exp, doc (showString ")")])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
