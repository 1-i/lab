...
Ass :: { Ass }
Ass : Exp8 ':=' Exp ';' { AbsGram.DAss $1 $3 }
Exp2 :: { Exp }
Exp2 : Exp2 'or' Exp3 { AbsGram.EOr $1 $3 } | Exp3 { $1 }
Exp3 :: { Exp }
Exp3 : Exp3 'and' Exp4 { AbsGram.EAnd $1 $3 } | Exp4 { $1 }
Exp4 :: { Exp }
Exp4 : Exp4 '<' Exp5 { AbsGram.ELt $1 $3 }
     | Exp4 '>' Exp5 { AbsGram.EGt $1 $3 }
     | Exp5 { $1 }
Exp5 :: { Exp }
Exp5 : Exp5 '+' Exp6 { AbsGram.EAdd $1 $3 }
     | Exp5 '-' Exp6 { AbsGram.ESub $1 $3 }
     | Exp6 { $1 }
Exp6 :: { Exp }
Exp6 : Exp6 '*' Exp7 { AbsGram.EMul $1 $3 }
     | Exp6 '/' Exp7 { AbsGram.EDiv $1 $3 }
     | Exp7 { $1 }
Exp8 :: { Exp }
Exp8 : '*' Exp7 { AbsGram.EDeref $2 }
     | '!' Exp7 { AbsGram.ENot $2 }
     | Exp9 { $1 }
Exp9 :: { Exp }
Exp9 : Exp9 '[' Exp ']' { AbsGram.EArr $1 $3 } | Exp10 { $1 }
Exp10 :: { Exp }
Exp10 : Ident '(' ListExp ')' { AbsGram.ECall $1 $3 }
